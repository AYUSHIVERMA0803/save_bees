...
var _enterViewScrolly = require("../scrolly/enterViewScrolly");
var _enterViewScrollyDefault = parcelHelpers.interopDefault(_enterViewScrolly);
/**
...
(0, _enterViewScrollyDefault.default)("#map-scrolly");
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"a8jxY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _enterViewDefault = parcelHelpers.interopDefault(_enterView);
/**
  ---------------
  VERICAL SCROLLY
  ---------------
 ...
 */ const enterViewScrolly = (scrollerEl, stacked)=>{
    ...
    window.addEventListener("DOMContentLoaded", (0, _lodashDebounceDefault.default)(()=>{
        _resize(scrollerEl);
    }, 150));
    window.addEventListener("resize", (0, _lodashDebounceDefault.default)(()=>{
        _resize(scrollerEl);
    }, 150));
    /* Enter Trigger */ (0, _enterViewDefault.default)({
        ...
        offset: 1,
        enter: (el)=>{
            document.querySelector(`${scrollerEl} .scroll-background`).classList.remove("unfixed");
            document.querySelector(`${scrollerEl} .scroll-background`).classList.add("fixed");
        },
        exit: (el)=>{
            document.querySelector(`${scrollerEl} .scroll-background`).classList.remove("fixed");
        }
    });
    /* Exit Trigger */ (0, _enterViewDefault.default)({
        selector: `${scrollerEl} .scroll-exit`,
        offset: 0,
        enter: (el)=>{
            document.querySelector(`${scrollerEl} .scroll-background`).classList.add("unfixed");
            document.querySelector(`${scrollerEl} .scroll-background`).classList.remove("fixed");
        },
        exit: (el)=>{
            document.querySelector(`${scrollerEl} .scroll-background`).classList.remove("unfixed");
...
},{"lodash.debounce":"3JP5n","enter-view":"cTpXj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3JP5n":[function(require,module,exports) {
var global = arguments[3];
/**
...
},{}],"cTpXj":[function(require,module,exports) {
(function(factory) {
    if (typeof define === "function" && define.amd) define(factory);
    else if (module.exports) module.exports = factory();
    else window.enterView = factory.call(this);
})(()=>{
    const lib = ({ selector: selector1 , enter: enter = ()=>{} , exit: exit = ()=>{} , progress: progress = ()=>{} , offset: offset = 0 , once: once = false  })=>{
        let raf = null;
        let ticking = false;
        let elements = [];
        let height1 = 0;
        ...
        function getOffsetHeight() {
            if (offset && typeof offset === "number") {
                ...
                return height1 - fraction * height1;
            }
            return height1;
        }
        ...
        function selectionToArray(selection) {
            ...
            const result = [];
            for(let i = 0; i < len; i += 1)result.push(selection[i]);
            return result;
        }
        function selectAll(selector, parent = document) {
            if (typeof selector === "string") return selectionToArray(parent.querySelectorAll(selector));
...
},{}]},["7ZoMj","8lRBv"], "8lRBv", "parcelRequirea8d1")
